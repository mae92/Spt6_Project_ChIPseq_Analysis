...
fCount1 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME029_S13_Spt6_AID_DMSO_Spt5_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount2 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME031_S15_Spt6_AID_DMSO_Spt5_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount3 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME030_S14_Spt6_AID_IAA_Spt5_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount4 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME032_S16_Spt6_AID_IAA_Spt5_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
...
conditions <- c("Spt5_DMSO", "Spt5_DMSO",
                "Spt5_IAA", "Spt5_IAA")
...
rownames(coldata) <- (c("Spt5_DMSO", "Spt5_DMSO",
                        "Spt5_IAA", "Spt5_IAA"))
...
#dds <- DESeq(dds)
resultsNames(dds)
sizeFactors(dds) <- c(1/7.51591, 1/7.85676, 1/8.06556, 1/9.09769)

dds = estimateDispersions(dds) 
dds = nbinomWaldTest(dds)

#!!!input contrasting conditions here 
contrast=c("condition","Spt5_IAA","Spt5_DMSO")
Spt5_IAA_vs_Spt5_DMSO <- results(dds, contrast, pAdjustMethod = "fdr")

write.table(subset(Spt5_IAA_vs_Spt5_DMSO, padj < 0.05), file="Spt5_IAA_vs_Spt5_DMSO_significant.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)


write.table(subset(Spt5_IAA_vs_Spt5_DMSO, log2FoldChange < -0.58), file="Spt5_IAA_vs_Spt5_DMSO_l2fc_less_than_-0.58.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)



#output is a results file comparing two conditions
png("Spt5_IAA_vs_Spt5_DMSO_MA_plot.png", height = 600, width = 600)
plotMA(Spt5_IAA_vs_Spt5_DMSO, ylim=c(-5,5), alpha = 0.05, xlab = "NCIS Normalized Read Counts")
dev.off()
