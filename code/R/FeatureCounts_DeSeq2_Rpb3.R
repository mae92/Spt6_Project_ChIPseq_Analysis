...
fCount1 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME021_S5_Spt6_AID_DMSO_Rpb3_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount2 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME023_S7_Spt6_AID_DMSO_Rpb3_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount3 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME022_S6_Spt6_AID_IAA_Rpb3_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount4 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME024_S8_Spt6_AID_IAA_Rpb3_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
...
conditions <- c("Rpb3_DMSO", "Rpb3_DMSO",
                "Rpb3_IAA", "Rpb3_IAA")
...
rownames(coldata) <- (c("Rpb3_DMSO", "Rpb3_DMSO",
                        "Rpb3_IAA", "Rpb3_IAA"))
...
#dds <- DESeq(dds)
resultsNames(dds)
sizeFactors(dds) <- c(1/2.73061, 1/2.31991, 1/3.27645, 1/3.44009)

dds = estimateDispersions(dds) 
dds = nbinomWaldTest(dds)

#!!!input contrasting conditions here 
contrast=c("condition","Rpb3_IAA","Rpb3_DMSO")
Rpb3_IAA_vs_Rpb3_DMSO <- results(dds, contrast, pAdjustMethod = "fdr")

write.table(subset(Rpb3_IAA_vs_Rpb3_DMSO, padj < 0.05), file="Rpb3_IAA_vs_Rpb3_DMSO_significant.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)


write.table(subset(Rpb3_IAA_vs_Rpb3_DMSO, log2FoldChange < -0.58), file="Rpb3_IAA_vs_Rpb3_DMSO_l2fc_less_than_-0.58.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)



#output is a results file comparing two conditions
png("Rpb3_IAA_vs_Rpb3_DMSO_MA_plot.png", height = 600, width = 600)
plotMA(Rpb3_IAA_vs_Rpb3_DMSO, ylim=c(-5,5), alpha = 0.05, xlab = "NCIS Normalized Read Counts")
dev.off()
