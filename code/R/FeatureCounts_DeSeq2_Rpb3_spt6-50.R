...
fCount1 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/spt6_50_subset_bams/ME001_S1_WT_Rpb3_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount2 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/spt6_50_subset_bams/ME002_S2_WT_Rpb3_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount3 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/spt6_50_subset_bams/ME003_S3_spt6_50_Rpb3_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount4 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/spt6_50_subset_bams/ME004_S4_spt6_50_Rpb3_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
...
conditions <- c("Rpb3_WT", "Rpb3_WT",
                "Rpb3_spt6_50", "Rpb3_spt6_50")
...
rownames(coldata) <- (c("Rpb3_WT", "Rpb3_WT",
                        "Rpb3_spt6_50", "Rpb3_spt6_50"))
...
#dds <- DESeq(dds)
resultsNames(dds)
sizeFactors(dds) <- c(1/2.74564, 1/2.94668, 1/4.245, 1/3.36276)

dds = estimateDispersions(dds) 
dds = nbinomWaldTest(dds)

#!!!input contrasting conditions here 
contrast=c("condition","Rpb3_spt6_50","Rpb3_WT")
Rpb3_spt6_50_vs_Rpb3_WT <- results(dds, contrast, pAdjustMethod = "fdr")

write.table(subset(Rpb3_spt6_50_vs_Rpb3_WT, padj < 0.05), file="Rpb3_spt6_50_vs_Rpb3_WT_significant.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)


write.table(subset(Rpb3_spt6_50_vs_Rpb3_WT, log2FoldChange < -0.58), file="Rpb3_spt6_50_vs_Rpb3_WT_l2fc_less_than_-0.58.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)



#output is a results file comparing two conditions
png("Rpb3_spt6_50_vs_Rpb3_WT_MA_plot.png", height = 600, width = 600)
plotMA(Rpb3_spt6_50_vs_Rpb3_WT, ylim=c(-5,5), alpha = 0.05, xlab = "NCIS Normalized Read Counts")
dev.off()
