...
fCount1 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME025_S9_Spt6_AID_DMSO_Spt6_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount2 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME027_S11_Spt6_AID_DMSO_Spt6_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount3 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME026_S10_Spt6_AID_IAA_Spt6_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount4 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/Spt6_AID_EF_subset_bams/ME028_S12_Spt6_AID_IAA_Spt6_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
...
conditions <- c("Spt6_DMSO", "Spt6_DMSO",
                "Spt6_IAA", "Spt6_IAA")
...
rownames(coldata) <- (c("Spt6_DMSO", "Spt6_DMSO",
                        "Spt6_IAA", "Spt6_IAA"))
...
#dds <- DESeq(dds)
resultsNames(dds)
sizeFactors(dds) <- c(1/12.5069, 1/15.1892, 1/2.36979, 1/3.65175)

dds = estimateDispersions(dds) 
dds = nbinomWaldTest(dds)

#!!!input contrasting conditions here 
contrast=c("condition","Spt6_IAA","Spt6_DMSO")
Spt6_IAA_vs_Spt6_DMSO <- results(dds, contrast, pAdjustMethod = "fdr")

write.table(subset(Spt6_IAA_vs_Spt6_DMSO, padj < 0.05), file="Spt6_IAA_vs_Spt6_DMSO_significant.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)


write.table(subset(Spt6_IAA_vs_Spt6_DMSO, log2FoldChange < -0.58), file="Spt6_IAA_vs_Spt6_DMSO_l2fc_less_than_-0.58.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)



#output is a results file comparing two conditions
png("Spt6_IAA_vs_Spt6_DMSO_MA_plot.png", height = 600, width = 600)
plotMA(Spt6_IAA_vs_Spt6_DMSO, ylim=c(-5,5), alpha = 0.05, xlab = "NCIS Normalized Read Counts")
dev.off()
