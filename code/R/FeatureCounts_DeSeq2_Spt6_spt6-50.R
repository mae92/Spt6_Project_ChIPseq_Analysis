...
fCount1 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/spt6_50_subset_bams/ME005_S5_WT_Spt6_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount2 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/spt6_50_subset_bams/ME006_S6_WT_Spt6_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount3 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/spt6_50_subset_bams/ME007_S7_spt6_50_Spt6_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount4 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/spt6_50_subset_bams/ME008_S8_spt6_50_Spt6_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
...
conditions <- c("Spt6_WT", "Spt6_WT",
                "Spt6_spt6_50", "Spt6_spt6_50")
...
rownames(coldata) <- (c("Spt6_WT", "Spt6_WT",
                        "Spt6_spt6_50", "Spt6_spt6_50"))
...
#dds <- DESeq(dds)
resultsNames(dds)
sizeFactors(dds) <- c(1/13.0194, 1/15.0817, 1/8.57515, 1/7.67978)

dds = estimateDispersions(dds) 
dds = nbinomWaldTest(dds)

#!!!input contrasting conditions here 
contrast=c("condition","Spt6_spt6_50","Spt6_WT")
Spt6_spt6_50_vs_Spt6_WT <- results(dds, contrast, pAdjustMethod = "fdr")

write.table(subset(Spt6_spt6_50_vs_Spt6_WT, padj < 0.05), file="Spt6_spt6_50_vs_Spt6_WT_significant.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)


write.table(subset(Spt6_spt6_50_vs_Spt6_WT, log2FoldChange < -0.58), file="Spt6_spt6_50_vs_Spt6_WT_l2fc_less_than_-0.58.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)



#output is a results file comparing two conditions
png("Spt6_spt6_50_vs_Spt6_WT_MA_plot.png", height = 600, width = 600)
plotMA(Spt6_spt6_50_vs_Spt6_WT, ylim=c(-5,5), alpha = 0.05, xlab = "NCIS Normalized Read Counts")
dev.off()
