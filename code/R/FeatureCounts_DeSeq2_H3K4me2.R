...
fCount1 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/H3K4me2_subset_bams/ME124_S10_Spt6_AID_DMSO_H3K4me2_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount2 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/H3K4me2_subset_bams/ME117_S3_Spt6_AID_DMSO_H3K4me2_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount3 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/H3K4me2_subset_bams/ME125_S11_Spt6_AID_IAA_H3K4me2_1_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
fCount4 <- featureCounts(files="/Volumes/Mitch_Home_Backup/Mitch_Ellison_Data_All_UPitt_2015_to_2020/ChIP_seq_Analysis_Docker_started_on_11012020/sc_bam/H3K4me2_subset_bams/ME068_S20_Spt6_AID_IAA_H3K4me2_2_subsample_sorted.bam",
                         annot.ext=annotFile, isGTFAnnotationFile=TRUE, GTF.featureType=feature, GTF.attrType="gene_id")
...
conditions <- c("H3K4me2_DMSO", "H3K4me2_DMSO",
                "H3K4me2_IAA", "H3K4me2_IAA")
...
rownames(coldata) <- (c("H3K4me2_DMSO", "H3K4me2_DMSO",
                        "H3K4me2_IAA", "H3K4me2_IAA"))
...
#dds <- DESeq(dds)
resultsNames(dds)
sizeFactors(dds) <- c(1/6.57999, 1/6.73192, 1/6.12003, 1/6.50826)

dds = estimateDispersions(dds) 
dds = nbinomWaldTest(dds)

#!!!input contrasting conditions here 
contrast=c("condition","H3K4me2_IAA","H3K4me2_DMSO")
H3K4me2_IAA_vs_H3K4me2_DMSO <- results(dds, contrast, pAdjustMethod = "fdr")

write.table(subset(H3K4me2_IAA_vs_H3K4me2_DMSO, padj < 0.05), file="H3K4me2_IAA_vs_H3K4me2_DMSO_significant.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)


write.table(subset(H3K4me2_IAA_vs_H3K4me2_DMSO, log2FoldChange < -0.58), file="H3K4me2_IAA_vs_H3K4me2_DMSO_l2fc_less_than_-0.58.tsv", 
            sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)



#output is a results file comparing two conditions
png("H3K4me2_IAA_vs_H3K4me2_DMSO_MA_plot.png", height = 600, width = 600)
plotMA(H3K4me2_IAA_vs_H3K4me2_DMSO, ylim=c(-5,5), alpha = 0.05, xlab = "NCIS Normalized Read Counts")
dev.off()
